...
import ru.tusur.ShaurmaWebSiteProject.backend.model.AvatarImage;
...
public class AvatarField extends CustomField<AvatarImage> {
    ...
    private void uploadSuccess(SucceededEvent e) {
        ...
        byte[] inputStream = value.getImage();
        try {
            Files.write(Path.of("src/main/resources/META-INF/resources/images/" + fileName), inputStream);
