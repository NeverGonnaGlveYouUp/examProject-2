...
import ru.tusur.ShaurmaWebSiteProject.ui.utils.MyBorderColor;


// TODO: Needs a new name to avoid clashing with the default.
public class MyNotification extends Layout implements HasTheme {

    private MyBorderColor borderColor;
    ...
    public MyNotification(String title, String description, Type type) {
        this(title, new Text(description), type);
    }

    public MyNotification(String title, Component description) {
        this(title, description, Type.INFO);
    }

    public MyNotification(String title, Component description, Type type) {
     ...
     */
    private void setBorderColor(MyBorderColor borderColor) {
    ...
    private void setType(Type type) {
        ...
        switch (type) {
            case INFO:
            default:
                setBorderColor(MyBorderColor.PRIMARY_50);
                ...
                break;
            case SUCCESS:
                setBorderColor(MyBorderColor.SUCCESS_50);
                getElement().setAttribute("role", "status");
                ...
                break;
            case ERROR:
                setBorderColor(MyBorderColor.ERROR_50);
    ...
    private void themeButton(Button button) {
        if (this.type.equals(MyNotification.Type.SUCCESS)) {
            button.addThemeVariants(ButtonVariant.LUMO_SUCCESS);
        } else if (this.type.equals(MyNotification.Type.ERROR)) {
